    ...
    <header id="header">
      ...
      if($data['github']!=""){
        ...
        ?>
            ...
            <nav class="nav-menu">
                <ul>
                    <li class=""><a href="#hero"><i class="bx bx-home"></i> <span>Нүүр хуудас</span></a></li>
                    <li><a href="#about"><i class="bx bx-user"></i> <span>Мэдээлэл</span></a></li>
                    <li><a href="#resume"><i class="bx bx-file-blank"></i> <span>Боловсрол</span></a></li>
                    <li><a href="#portfolio"><i class="bx bx-book-content"></i>Бүтээл</a></li>
                    <li><a href="#contact"><i class="bx bx-envelope"></i>Холбоо барих</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        ...
                        <div>
                            <ul class="row">
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Нэр :</strong> <?=$data['name']?></li>
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Төрсөн өдөр :</strong> <?=$data['dob']?></li>
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Имайл хаяг :</strong> <?=$data['emailid']?></li>
                                <li class="col-lg-5"><i class="icofont-rounded-right"></i> <strong>Утасны дугаар :</strong> <?=$data['mobile']?></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-up">
                        <h3 class="resume-title">Их сургууль</h3>
                        <?php
...
while($data4=mysqli_fetch_array($runquery4)){
    ?>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <h3 class="resume-title">Дунд боловсрол</h3>
                    ...
                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                        <form action="include/message.php" method="post" role="form" class="php-email-form">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="name">Имайл хаяг</label>
                                    <input type="email" class="form-control" name="email" id="email" data-rule="email" data-msg="Please enter a valid email" />
                                    <div class="validate"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name">Сэдэв</label>
                            ...
                            <div class="text-center"><button type="submit">Message илгээх</button></div>
                        </form>
                    </div>
<!--
