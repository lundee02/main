...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2023 at 08:44 AM
...
(1, 'Prince', 'admin@admin.com', 'admin123', 1);
...
(1, 'Prince', 'i am a web developer, i make website and php web portals .', 'web development,php development', 'icons8-computer-support-64.png');
...
(18, 'prince', 'prince@main.com', 'new website', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.');
...
(1, 'user.jpg', 'Prince', 'https://www.instagram.com', 'https://www.facebook.com', 'https://www.instagram.com', '@abcd', 'https://in.linkedin.com', 'https://github.com/naemazam/', 'rsz_1corridor-dark-station-sci-fi-art-7dbsv7qvib6z0bp7.jpg', 'Web Developer,PHP Developer,Youtuber,Graphic Designer', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '+123456789', 'prince@gmail.com');
...
(14, 'Portfolio website', '2p.PNG', 'https://github.com/naemazam'),
(18, 'Portfolio website', '1p.PNG', 'https://github.com/naemazam'),
(20, 'Portfolio website', 'trm.PNG', 'https://github.com/naemazam');
